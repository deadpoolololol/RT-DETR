...
class ConvertCocoPolysToMask(object):
    ...
    def __call__(self, image, target):
        ...
        # print(f"All category IDs in annotations: {[obj['category_id'] for obj in target['annotations']]}")
        # # 去除无效目标（iscrowd 和无效类别）
        # invalid_categories = {1, 12}  # 假设无效类别none,others ID为 1 和 12 从1开始编号
        # anno = [obj for obj in anno if (obj['category_id'] not in invalid_categories) and 
